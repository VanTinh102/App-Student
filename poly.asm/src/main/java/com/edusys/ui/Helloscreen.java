 ...
 * @author nongn
 */
public class Helloscreen extends javax.swing.JDialog {

    /**
     * Creates new form Helloscreen
     */
    public Helloscreen(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/image/welcome.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Helloscreen dialog = new Helloscreen(new javax.swing.JFrame(), true);
        ...
        new Timer(10,new ActionListener() {//hàm Timer cứ 10ms chạy 1%
            ...
            public void actionPerformed(ActionEvent e) {
             ...
             if(value<pgbloading.getMaximum()){
                 ...
                 Helloscreen.this.dispose();//dispose(): là đóng cửa sổ
             }
            }
        }).start();
    }
